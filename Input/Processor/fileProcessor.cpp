...
/**
 * main method with fixed input file name
 */
int main() {
    string inputFileName = "input.ext";  // Fixed input file name
    ...
    // Process the file
    int result = fileProcessor(inputFileName);

    if (result == 0) {
        cout << "Processing complete. Output written to output-tmp.txt" << endl;
    }
